...
/* harmony export */ });
console.log("http://44.203.58.169:8080");
const defaultStyles = {
    border: "none",
    "z-index": 2147483647,
    height: "650px",
...
const Widget = {
    ...
    createIframe: function () {
        ...
        this.iframe.src = `${"http://44.203.58.169:8080"}`;
    ...
    handleMessage: function (e) {
        ...
        if (!e.data || typeof e.data !== "string")
            return;
        try {
            const data = (_a = JSON.parse(e.data)) !== null && _a !== void 0 ? _a : {};
...
/******/ 	(() => {
/******/ 		__webpack_require__.h = () => ("eaecc5c5e1a9109ab5f6")
/******/ 	})();
/******/ 	
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "budgets-and-insights:";
...
/******/ 		}
/******/ 		
/******/ 		self["webpackHotUpdatebudgets_and_insights"] = (chunkId, moreModules, runtime) => {
...
/******/ 	var __webpack_exports__ = __webpack_require__("./src/server/widget.ts");
