    ...
    <div className="h-screen w-screen relative no-scrollbar">
      <div className="h-1/4 absolute top-0 left-0 right-0">
        ...
        <div className="flex flex-col mx-6 absolute top-28 left-0 right-0">
          ...
          <div className="mt-6">
            <div className="flex flex-row justify-center mx-4 font-custom text-base text-center font-semibold tracking-title">
              Unlock easy spend tracking and savings.
            </div>
            <div className="flex flex-row justify-center items center text-xs font-primary tracking-wide text-center text-skin-base mt-3 font-medium">
            ...
            <div className="flex flex-row justify-center text-xs font-primary text-center text-skin-neutral mt-1 tracking-longest_text">
              Learn more
            </div>
          </div>
        </div>
